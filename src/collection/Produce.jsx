    ...
    <section className="product-section">
      ...
      <div className="container">
        ...
        <div className="product-section-heading">
          ...
          <span className="product-section-tag">
            Zanny Beauty Palace
          </span>
...
<Navbar/>
      ...
      <section className="products-hero">
        ...
        <div className="container">
          ...
          <p>
            Explore our collection of quality beauty products,
            hair extensions, and footwear.
          </p>
      ...
      <ProductSection
        title="Weavons"
        description="Explore our beautiful collection of quality weavons."
        products={weavons}
      />
      ...
      <ProductSection
        title="Frontals"
        description="Find the perfect frontal to complete your look."
        products={frontals}
      />
      ...
      <ProductSection
        title="Closures"
        description="Quality closures selected for beautiful hairstyles."
        products={closures}
      />
